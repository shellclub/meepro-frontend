...
import SingleProductContentById from "./single-product-content/SingleProductContentById";
import useGetProductById from "@/hooks/product/useGetProductById";
import ProductDiscountContent from "./discount-content/ProductDiscountContent";
import SidebarAreaCustom from "../shop-sidebar/sidebar-area/SidebarAreaCustom";
    ...
    <>
      ...
      >
        ...
        <div className="single-pro-block">
          <SingleProductContentById productData={productData || undefined} />
        </div>
        ...
        {/* <ProductTeb /> */}
        <ProductDiscountContent productData={productData} />

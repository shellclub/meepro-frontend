        ...
        <div id="shop_sidebar">
          <div className="gi-sidebar-wrap">
            ...
            <div className="gi-sidebar-block">
              ...
              >
                <h3 className="gi-sidebar-title">ประเภทสินค้า</h3>
                <div
            ...
            <div className="gi-sidebar-block">
              <div
                ...
                className="gi-sb-title"
              >
                <h3 className="gi-sidebar-title">ราคา</h3>
                <div
                  style={{ cursor: "pointer" }}
...
export default SidebarAreaCustom;
